<nav class="navbar navbar-expand-lg navbar-light " id="nav-estilo">
    ...
    <img id="logocar" src="img/logocar.jpg">
      <ul class="navbar-nav">  
           <li class="nav-item">
          <a class="nav-link active" aria-current="page" href="home" style="font-size: 24px;">Mapa</a>
        </li>
        <li class="nav-item">
          <a class="nav-link active" area-current="page" href="conductors" style="font-size: 24px;">Conductores</a>
        </li>
        <li class="nav-item">
        ...
        <li class="nav-item">
          ...
          <a type="button" class="btn btn-secondary" href="/logout" style="margin-left:18em: margin-top:-60px">
